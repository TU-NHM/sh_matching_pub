...
parser = argparse.ArgumentParser(description="Script to parse USEARCH clustering output (90) for next step clustering (80)")
...
file = user_dir / "clusters_90.uc"
tmp_file1 = user_dir / "clusters_out_90.txt"
tmp_file2 = user_dir / "nohits.fasta"
tmp_file3 = user_dir / "in_80.fasta"
