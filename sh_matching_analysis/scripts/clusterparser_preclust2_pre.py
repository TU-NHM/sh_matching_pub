...
parser = argparse.ArgumentParser(description="Script to parse USEARCH preclustering output (95) for next clustering step (90)")
...
file = user_dir / "clusters_95_pre.uc"
tmp_file1 = user_dir / "clusters_out_95_pre.txt"
tmp_file2 = user_dir / "iupac_out_vsearch.fasta"
tmp_file3 = user_dir / "in_90_pre.fasta"
